...
const Map = dynamic(() => import("@/app/components/home/LiveMap"), {
  ssr: false,
  loading: () => (
    <div className="bg-gray-200 h-full animate-pulse rounded-lg"></div>
  ),
});
            ...
            <div className="bg-white shadow rounded-lg overflow-hidden">
              ...
              <div className="h-96">
                <Map
                  ...
                  emergencyLocation={activeEmergency?.location}
                  hospitalLocation={{ lat: 12.9716, lng: 77.5946 }} // Sample
                />
              </div>
            </div>
